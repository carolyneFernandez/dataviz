...
function dbRemplissageJour1(cityModelData,
...
function dbRemplissageJour2(cityModelData2, temperatureModelData2, cloudModelData2, windModelData2, precipitationModelData2, cityName, cityPression2, cityHumidity2, cityWeather2, dateRetrive2, cityIcon2) {
    ...
    return new Promise(resolve => {
        City.findOne({ where: { name: cityName } }).then(findedCity => {
            ...
            Temperature.create(temperatureModelData2).then(newTemp => {
                var newTempId2 = newTemp.get("id");
                Cloud.create(cloudModelData2).then(newCloud => {
                    var newCloudId2 = newCloud.get("id");
                    Wind.create(windModelData2).then(newWind => {
                        var newWindId2 = newWind.get("id");
                        Precipitation.create(precipitationModelData2).then(newPrecipitation => {
...
function dbRemplissageJour3(cityModelData3, temperatureModelData3, cloudModelData3, windModelData3, precipitationModelData3, cityName, cityPression3, cityHumidity3, cityWeather3, dateRetrive3, cityIcon3) {

    return new Promise(resolve => {
        City.findOne({ where: { name: cityName } }).then(findedCity => {
            var findedCityId = findedCity.get("id");
            Temperature.create(temperatureModelData3).then(newTemp => {
                var newTempId3 = newTemp.get("id");
                Cloud.create(cloudModelData3).then(newCloud => {
                    var newCloudId3 = newCloud.get("id");
                    Wind.create(windModelData3).then(newWind => {
                        var newWindId3 = newWind.get("id");
                        Precipitation.create(precipitationModelData3).then(newPrecipitation => {
...
function dbRemplissageJour4(cityModelData4, temperatureModelData4, cloudModelData4, windModelData4, precipitationModelData4, cityName, cityPression4, cityHumidity4, cityWeather4, dateRetrive4, cityIcon4) {

    return new Promise(resolve => {
        City.findOne({ where: { name: cityName } }).then(findedCity => {
            var findedCityId = findedCity.get("id");
            Temperature.create(temperatureModelData4).then(newTemp => {
                var newTempId4 = newTemp.get("id");
                Cloud.create(cloudModelData4).then(newCloud => {
                    var newCloudId4 = newCloud.get("id");
                    Wind.create(windModelData4).then(newWind => {
                        var newWindId4 = newWind.get("id");
                        Precipitation.create(precipitationModelData4).then(newPrecipitation => {
...
function dbRemplissageJour5(cityModelData5, temperatureModelData5, cloudModelData5, windModelData5, precipitationModelData5, cityName, cityPression5, cityHumidity5, cityWeather5, dateRetrive5, cityIcon5) {

    return new Promise(resolve => {
        City.findOne({ where: { name: cityName } }).then(findedCity => {
            var findedCityId = findedCity.get("id");
            Temperature.create(temperatureModelData5).then(newTemp => {
                var newTempId5 = newTemp.get("id");
                Cloud.create(cloudModelData5).then(newCloud => {
                    var newCloudId5 = newCloud.get("id");
                    Wind.create(windModelData5).then(newWind => {
                        var newWindId5 = newWind.get("id");
                        Precipitation.create(precipitationModelData5).then(newPrecipitation => {
...
async function requestAndDb(cityName, cityCode, cityDepartement, cityLong, cityLat) {
    //return new Promise(resolve => {
    ...
    request_rp(options).then(responseBody => {
        parseString(responseBody, async function(err, result) {
            ...
            if (result.weatherdata.forecast[0].time[0].precipitation[0].$ === undefined) {
                cityPrecipitationValue = null;
                cityPrecipitationMode = "";
            } else {
                cityPrecipitationValue = result.weatherdata.forecast[0].time[0].precipitation[0].$.value;
                cityPrecipitationMode = result.weatherdata.forecast[0].time[0].precipitation[0].$.type;
            }

            windDegree = result.weatherdata.forecast[0].time[0].windDirection[0].$.deg;
            ...
            var cityPression2 = result.weatherdata.forecast[0].time[8].pressure[0].$.value;
            var cityHumidity2 = result.weatherdata.forecast[0].time[8].humidity[0].$.value;
            var cityWeather2 = result.weatherdata.forecast[0].time[8].symbol[0].$.name;
            var cityIcon2 = result.weatherdata.forecast[0].time[8].symbol[0].$.var;

            var cityPrecipitationValue2;
            var cityPrecipitationMode2;

            if (result.weatherdata.forecast[0].time[8].precipitation[0].$ === undefined) {
                cityPrecipitationValue2 = null;
                cityPrecipitationMode2 = "";
            } else {
                cityPrecipitationValue2 = result.weatherdata.forecast[0].time[8].precipitation[0].$.value;
                cityPrecipitationMode2 = result.weatherdata.forecast[0].time[8].precipitation[0].$.type;
            }


            var windDegree2 = result.weatherdata.forecast[0].time[8].windDirection[0].$.deg;
            var windCode2 = result.weatherdata.forecast[0].time[8].windDirection[0].$.code;
            var windName2 = result.weatherdata.forecast[0].time[8].windDirection[0].$.name;
            ...
            setTimeout(dbRemplissageJour2, 35000,
                cityModelData2,
                temperatureModelData2,
                cloudModelData2,
                windModelData2,
            ...
            var cityPression3 = result.weatherdata.forecast[0].time[16].pressure[0].$.value;
            var cityHumidity3 = result.weatherdata.forecast[0].time[16].humidity[0].$.value;
            var cityWeather3 = result.weatherdata.forecast[0].time[16].symbol[0].$.name;
            var cityIcon3 = result.weatherdata.forecast[0].time[16].symbol[0].$.var;

            var cityPrecipitationValue3;
            var cityPrecipitationMode3;

            if (result.weatherdata.forecast[0].time[16].precipitation[0].$ === undefined) {
                cityPrecipitationValue3 = null;
                cityPrecipitationMode3 = "";
            } else {
                cityPrecipitationValue3 = result.weatherdata.forecast[0].time[16].precipitation[0].$.value;
                cityPrecipitationMode3 = result.weatherdata.forecast[0].time[16].precipitation[0].$.type;
            }


            var windDegree3 = result.weatherdata.forecast[0].time[16].windDirection[0].$.deg;
            var windCode3 = result.weatherdata.forecast[0].time[16].windDirection[0].$.code;
            var windName3 = result.weatherdata.forecast[0].time[16].windDirection[0].$.name;
            ...
            setTimeout(dbRemplissageJour3, 70000, cityModelData3, temperatureModelData3, cloudModelData3, windModelData3,
                precipitationModelData3, cityName, cityPression3, cityHumidity3, cityWeather3, dateRetrive3, cityIcon3);
            ...
            var cityPression4 = result.weatherdata.forecast[0].time[24].pressure[0].$.value;
            var cityHumidity4 = result.weatherdata.forecast[0].time[24].humidity[0].$.value;
            var cityWeather4 = result.weatherdata.forecast[0].time[24].symbol[0].$.name;
            var cityIcon4 = result.weatherdata.forecast[0].time[24].symbol[0].$.var;

            var cityPrecipitationValue4;
            var cityPrecipitationMode4;

            if (result.weatherdata.forecast[0].time[24].precipitation[0].$ === undefined) {
                cityPrecipitationValue4 = null;
                cityPrecipitationMode4 = "";
            } else {
                cityPrecipitationValue4 = result.weatherdata.forecast[0].time[24].precipitation[0].$.value;
                cityPrecipitationMode4 = result.weatherdata.forecast[0].time[24].precipitation[0].$.type;
            }


            var windDegree4 = result.weatherdata.forecast[0].time[24].windDirection[0].$.deg;
            var windCode4 = result.weatherdata.forecast[0].time[24].windDirection[0].$.code;
            var windName4 = result.weatherdata.forecast[0].time[24].windDirection[0].$.name;
            ...
            setTimeout(dbRemplissageJour4, 140000, cityModelData4, temperatureModelData4, cloudModelData4, windModelData4,
                precipitationModelData4, cityName, cityPression4, cityHumidity4, cityWeather4, dateRetrive4, cityIcon4);
            /**
             * CINQUIEME JOUR
             */
            var dateRetrive5 = result.weatherdata.forecast[0].time[32].$.to;
            var cityPression5 = result.weatherdata.forecast[0].time[32].pressure[0].$.value;
            var cityHumidity5 = result.weatherdata.forecast[0].time[32].humidity[0].$.value;
            var cityWeather5 = result.weatherdata.forecast[0].time[32].symbol[0].$.name;
            var cityIcon5 = result.weatherdata.forecast[0].time[32].symbol[0].$.var;

            var cityPrecipitationValue5;
            var cityPrecipitationMode5;

            if (result.weatherdata.forecast[0].time[32].precipitation[0].$ === undefined) {
                cityPrecipitationValue5 = null;
                cityPrecipitationMode5 = "";
            } else {
                cityPrecipitationValue5 = result.weatherdata.forecast[0].time[32].precipitation[0].$.value;
                cityPrecipitationMode5 = result.weatherdata.forecast[0].time[32].precipitation[0].$.type;
            }


            var windDegree5 = result.weatherdata.forecast[0].time[32].windDirection[0].$.deg;
            var windCode5 = result.weatherdata.forecast[0].time[32].windDirection[0].$.code;
            var windName5 = result.weatherdata.forecast[0].time[32].windDirection[0].$.name;
            ...
            setTimeout(dbRemplissageJour5, 280000, cityModelData5, temperatureModelData5, cloudModelData5, windModelData5,
                precipitationModelData5, cityName, cityPression5, cityHumidity5, cityWeather5, dateRetrive5, cityIcon5);
