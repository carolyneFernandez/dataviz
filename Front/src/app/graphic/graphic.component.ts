    ...
    this.servicePrevesion.getTemperaturePrevesion(this.city).subscribe((data) => {
      ...
      this.datasets=[
       
        {
          ...
          data: [this.dataCitieTimeMin[0], this.dataCitieTimeMin[1], this.dataCitieTimeMin[2],this.dataCitieTimeMin[3],this.dataCitieTimeMin[4]],
          backgroundColor: [
            'rgba(219, 10, 91, 1)',
            'rgba(219, 10, 91, 1)',
            'rgba(219, 10, 91, 1)',
        ...
        {
          label: 'Prevision',
          data: [this.dataCitieTime[0], this.dataCitieTime[1], this.dataCitieTime[2],this.dataCitieTime[3],this.dataCitieTime[4]],
          backgroundColor: [
            'rgba(34, 167, 240, 1)',
            'rgba(34, 167, 240, 1)',
            'rgba(34, 167, 240, 1)',
        ...
        },
        {
          ...
          data: [this.dataCitieTimeMax[0], this.dataCitieTimeMax[1], this.dataCitieTimeMax[2],this.dataCitieTimeMax[3],this.dataCitieTimeMax[4]],
          backgroundColor: [
            'rgba(247, 202, 24, 1)',
            'rgba(247, 202, 24, 1)',
            'rgba(247, 202, 24, 1)',
      ...
      this.labels = [this.dateTime[0], this.dateTime[1], this.dateTime[2], this.dateTime[3], this.dateTime[4]];
